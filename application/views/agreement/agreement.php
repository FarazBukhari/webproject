      ...
      <div class="contain">
            ...
            <div class="row first">
              ...
              <div class="full-copy">
                <p>
                  ...
                  Our User Agreement has been updated; <a onclick="LI.popup(this.href); return false;" href="<?php echo base_url('index.php/login/login/agreement');?>">click here for a summary of the changes</a>.
          ...
          <div class="section">
            ...
            <div class="row first">
              ...
              <div class="full-copy">
                ...
                <ul>
                  <li><a href="<?php echo base_url('index.php/login/login/agreement');?>">DOs and DON'Ts</a>;</li>
                  <li><a href="<?php echo base_url('index.php/login/login/agreement');?>">Complaints Regarding Content Posted on the LinkedIn Website</a>; and</li>
                  <li>
                    <a href="<?php echo base_url('index.php/login/login/agreement');?>">LinkedIn's Privacy Policy</a>.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="section">
            ...
            <div class="row">
              <div class="full-copy-no-brief">
                ...
                <p>In addition to Section 2.8. ("Notices and Service Messages"), we may notify you via postings on <a href="<?php echo base_url('index.php/login/login/index');?>">www.linkedin.com</a>. You may contact us <a href="<?php echo base_url('index.php/login/login/agreement');?>">here</a>. Or via mail or courier at: LinkedIn Corporation ATTN: Legal Department 2029 Stierlin Court Mountain View, CA 94043 USA   Additionally, LinkedIn accepts service of process at this address. Any notices that you provide without compliance with this section shall have no legal effect.</p>
              </div>
            </div>
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <div class="row">
              ...
              <div class="brief-copy">
                <p>Here's a list of some of the specific things we ask you to do and not do on LinkedIn. If you want a high-level summary of these, please check out our <a href="<?php echo base_url('index.php/login/login/agreement');?>">Professional Community Guidelines</a>.</p>
              </div>
              <div class="full-copy">
                <p>&nbsp;</p>
                <ol>
                  ...
                  <li>
                    Review and comply with our <a href="<?php echo base_url('index.php/login/login/agreement');?>">Privacy Policy</a>;
                  </li>
            ...
            <div class="row last">
              <div class="full-copy-no-brief">
                ...
                <ol>
                  ...
                  <li>Duplicate, license, sublicense, publish, broadcast, transmit, distribute, perform, display, sell, rebrand, or otherwise transfer information found on LinkedIn (excluding content posted by you) except as permitted in this Agreement, <a href="<?php echo base_url('index.php/login/login/agreement');?>">LinkedIn's developer terms and policies</a>, or as expressly authorized by LinkedIn;</li>
        ...
        <div class="row primary-separator" id="how-to-contact-us">
          <div class="contact">
            ...
            <div class="brief-copy">
              ...
              <p>If you have questions or comments about this User Agreement, please contact us <a href="<?php echo base_url('index.php/login/login/agreement');?>">online</a> or by physical mail at:</p>
            </div>
        ...
        <div class="row primary-separator">
          <div class="section">
            <div class="row last">
              <div class="full-copy-no-brief">
                <p>LinkedIn Corporation, Mountain View, California, USA, and LinkedIn Ireland Limited, Dublin, Ireland, September 12, 2013
                </p></div>
              </div>
            </div>
          </div>
