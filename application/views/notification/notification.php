...
<head>
	...
	<body>
		...
		if($_SESSION['num']>0){
			echo "<h3><Center>";
			echo "	<a href="; echo base_url('index.php/login/login/requests'); echo ">"; echo "You have ".$_SESSION['num']." new friend requests"; echo "</a>";
			echo "</Center></h3>";
		}
		else {
			echo "<Center><h3>There are no new requests.</h3></Center>";
		}
		?>
	</body>
</html>